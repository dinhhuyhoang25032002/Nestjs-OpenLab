import { Controller, Post, Body, HttpCode, HttpStatus, UseGuards, Req, Res, Get, Query } from '@nestjs/common';
...
export class AuthController {
    ...
    @Get()
    @UseGuards(JwtAccessAuthGuard)
    async addCookie(@Query() query: { id: string, email: string }, @Res() res: Response) {
